...
export function ContentCardFundamental1({ ...props }: IPropsCard) {
  return (
    <Card {...props}>
      <div>
        <p>
          O Ensino Fundamental destina-se à formação da criança visando ao
      ...
      <div>
        <p>
          O Ensino Fundamental I tem por objetivo a formação básica do cidadão
          mediante:
        </p>
        <p>
